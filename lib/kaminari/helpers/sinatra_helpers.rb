    ...
    module HelperMethods
      ...
      def paginate(scope, options = {}, &block)
        ...
        paginator = Kaminari::Helpers::Paginator.new(
          ...
          options.reverse_merge(:total_count => scope.total_count, :current_page => scope.current_page, :total_pages => scope.total_pages, :per_page => scope.limit_value, :param_name => Kaminari.config.param_name, :remote => false)
        )
        paginator.to_s
      end
