module Kaminari
  ...
  module ActionViewExtension
    ...
    def paginate(scope, options = {}, &block)
      ...
      paginator = Kaminari::Helpers::Paginator.new(self, options.reverse_merge(:total_count => scope.total_count, :current_page => scope.current_page, :per_page => scope.limit_value, :remote => false))
      paginator.to_s
    end
